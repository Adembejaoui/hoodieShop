  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h2 className="text-2xl font-bold">{t("coupons")} ({coupons.length})</h2>
      ...
      {showCouponForm && (
        <div className="bg-card rounded-lg border p-6">
          <h3 className="font-semibold mb-4">{t("createNewCoupon")}</h3>
          <form onSubmit={handleCreateCoupon} className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button type="submit">{t("createCoupon")}</Button>
              <Button
                type="button"
                variant="outline"
          ...
          <table className="w-full min-w-[700px]">
            <thead>
              <tr className="border-b bg-muted/50">
                ...
                <th className="text-left py-3 px-4">{t("discount")}</th>
                <th className="text-left py-3 px-4">{t("usage")}</th>
                <th className="text-left py-3 px-4">{t("expires")}</th>
                ...
                <tr key={coupon.id} className="border-b hover:bg-muted/25">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex gap-2">
                      ...
                      >
                        {coupon.active ? t("disable") : t("enable")}
                      </Button>
                      <Button
                        variant="outline"
                        size="sm"
