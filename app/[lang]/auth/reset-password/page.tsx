        ...
        >
          <div className="backdrop-blur-xl bg-black/40 rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
            ...
            <div className="relative bg-gradient-to-r from-purple-900/80 to-pink-900/80 p-6 sm:p-8 text-center border-b border-white/10">
              ...
              >
                {isSuccess ? t('success') : t('resetPassword')}
              </motion.h1>
              <motion.p
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
              ...
              >
                {isSuccess ? t('passwordChanged') : t('enterNewPassword')}
              </motion.p>
            </div>
              ...
              {isSuccess ? (
                ...
                <>
                  ...
                  <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                    <Field>
                      <FieldLabel className="text-white/80">{t('newPassword')}</FieldLabel>
                    ...
                    <Field>
                      <FieldLabel className="text-white/80">{t('confirmPassword')}</FieldLabel>
                      <div className="relative">
                        <Lock className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-white/40" />
                        <Input
                          id="confirmPassword"
