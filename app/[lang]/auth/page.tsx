...
const AnimeBackground = () => {
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden">
      ...
      />
      <motion.div
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-zinc-600/10 rounded-full blur-3xl"
        animate={{
          scale: [1, 1.3, 1],
          opacity: [0.2, 0.4, 0.2],
        }}
...
function AuthContent() {
  ...
  }, [status, session, searchParams, locale]);
  ...
  const tabs = [
    { key: "login" as const, label: t('signIn') },
    { key: "register" as const, label: t('createAccount') },
  ];
        ...
        >
          <div className="backdrop-blur-xl bg-black/40 rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
            ...
            <div className="relative bg-zinc-900 p-6 sm:p-8 text-center border-b border-white/10">
              {/* Logo with HOODIZ text underneath */}
              <motion.div
              ...
              >
                <Link href="/" className="flex flex-col items-center gap-3">
                  <HoodizLogo variant="icon" size="xl" />
                  <span className="text-3xl font-black tracking-tight bg-gradient-to-r from-white via-zinc-200 to-zinc-400 bg-clip-text text-transparent">
                    HOODIZ
                  </span>
                </Link>
              </motion.div>
