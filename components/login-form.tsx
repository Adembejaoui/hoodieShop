...
export function LoginForm({ className, darkMode = false }: LoginFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className={cn("flex flex-col gap-6", className)}>
      ...
      <FieldDescription className={darkMode ? "text-center text-white/40" : "text-center"}>
        Or continue with
      </FieldDescription>
      ...
      <Field>
        <Button
          ...
          disabled={isLoading}
          className={darkMode ? "w-full bg-white/5 border-white/20 text-white hover:bg-white/10" : ""}
        >
